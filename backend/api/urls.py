...
urlpatterns = [
    ...
    path('instituicao/identidade-visual', FrontendVisualIdentityView.as_view(), name='visual-identity-frontend'),
    path('instituicao/identidade-visual/', FrontendVisualIdentityView.as_view(), name='visual-identity-frontend-slash'),
    path('instituicao/identidade-visual/atualizar', FrontendVisualIdentityView.as_view(), name='visual-identity-update-frontend'),
    path('instituicao/identidade-visual/atualizar/', FrontendVisualIdentityView.as_view(), name='visual-identity-update-frontend-slash'),
